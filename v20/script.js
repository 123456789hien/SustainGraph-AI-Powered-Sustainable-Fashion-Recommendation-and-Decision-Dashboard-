...
const AUTOLOAD_URL =
  "https://raw.githubusercontent.com/123456789hien/SustainGraph-AI-Powered-Sustainable-Fashion-Recommendation-and-Decision-Dashboard-/refs/heads/main/v20/Kaggle_sust_dataset.csv";
...
btnRun.addEventListener("click", () => {
  ...
  try {
    ...
    renderMaterialTypePriceSIS(); // Render biểu đồ EDA
  } catch (err) {
    console.error(err);
