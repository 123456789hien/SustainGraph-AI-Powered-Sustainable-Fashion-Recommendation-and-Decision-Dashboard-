/* app.js - Scientific Version (Enhanced with Teacher's Feedback)
   ...
   3. Multi-Objective Optimization (Pareto Frontier) - FIXED LOGIC
...
function buildRecommendations(rowsWithSIS, topN = 5) {
  ...
  paretoItems.forEach((item, i) => {
    ...
    item.balanceScore = 0.5 * sisScore + 0.5 * priceScore;
  });
