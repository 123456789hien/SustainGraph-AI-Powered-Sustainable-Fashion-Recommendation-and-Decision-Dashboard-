...
loadSampleBtn.addEventListener("click", () => {
  ...
  fetch("https://raw.githubusercontent.com/123456789hien/SustainGraph-AI-Powered-Sustainable-Fashion-Recommendation-and-Decision-Dashboard-/refs/heads/main/ok1/Kaggle_sust_dataset.csv")
    .then((res) => res.text())
    .then((csv) => {
...
function renderRecommendationTab(tabId, items) {
  ...
  items.forEach((item, idx) => {
    ...
    div.innerHTML = `
      ...
      <div class="reco-note">Note: Pareto-optimal solutions are not ranked. Sorted by category logic (e.g., Max SIS for Max Sustainability)</div>
    `;
